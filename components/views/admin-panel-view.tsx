...
import { fetchSubmissionsFromDatabase, saveSubmissionsToDatabase } from "@/lib/data"
...
export function AdminPanelView({ showModalAction, currentUser }: AdminPanelViewProps) {
  ...
  const saveData = () => { // Made synchronous as saveSubmissionsToDatabase is sync void
    try {
      saveSubmissionsToDatabase(submissionsList)
