...
const generateISRC = (user: User, lastCounter: number) => {
    ...
    const isrc = `VNA2P${year}${String(newCounter).padStart(5, "18")}`
                    ...
                    <TabsContent value="media" className="space-y-6">
                        <Card>
                            <CardContent className="p-6 space-y-6">
                                ...
                                {/* Audio Upload */}
                                <div>
                                    <Label htmlFor="audioUpload">File nhạc (MP3, WAV, FLAC, tối đa 50MB mỗi file) *</Label>
                                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                                        <input
                                            id="audioUpload"
                                            type="file"
                                                    ...
                                                    <div key={track.id} className="border rounded-lg p-4">
                                                        ...
                                                        <div className="mt-4">
                                                            ...
                                                            {track.info.additionalArtists.map((artist, artistIndex) => (
                                                                <div key={`${track.id}-artist-${artistIndex}`} className="grid grid-cols-1 md:grid-cols-4 gap-2 mb-2 p-2 bg-gray-50 dark:bg-gray-800 rounded">
                                                                    <Input
                            ...
                            <CardContent className="p-6 space-y-4">
                                ...
                                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <p><strong>Thể loại:</strong> {mainCategory ?? "Chưa chọn"}</p>
                                        <p><strong>Kiểu phát hành:</strong> {releaseType ?? "Chưa chọn"}</p>
                                        <p><strong>Số track:</strong> {audioTracks.length}</p>
